document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFieldError(field) {
      ...
      const siblingError = field.parentNode.querySelector('.form-error-message');
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      showFormSuccess();
      // contactForm.reset(); // Uncomment if you want to reset after submission
    });
  }
  ...
  // Also observe elements with stagger groups
  ...
  if (staggerGroups.length > 0) {
    ...
    staggerGroups.forEach(function (group) {
      Array.from(group.children).forEach(function (child) {
        child.classList.add('fade-in-hidden');
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a3895ef3-c725-4ffd-b1df-06b4677e16f2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a3895ef3-c725-4ffd-b1df-06b4677e16f2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a3895ef3-c725-4ffd-b1df-06b4677e16f2';
